  ...
  <AppLayout>
    <div class="tenants-page">
      <div class="page-header">
        <h1 data-testid="page-title">租户管理</h1>
        <button 
      ...
      <!-- 租户列表 -->
      <div class="tenants-list" data-testid="tenants-list">
        ...
        <div v-else class="table-container">
          <table class="data-table">
            ...
            <tbody>
              <tr v-for="tenant in tenants" :key="tenant.id" :data-testid="`tenant-row-${tenant.id}`">
                <td>{{ tenant.name }}</td>
      ...
      <div v-if="showCreateModal" class="modal-overlay" @click="showCreateModal = false">
        <div class="modal" @click.stop>
          ...
          <div class="modal-footer">
            ...
            <button @click="createTenant" class="btn btn-primary" data-testid="confirm-create-btn">
              创建
            </button>
          </div>
        </div>
