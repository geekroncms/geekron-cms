...
export const collectionRoutes = new Hono<{ Bindings: Bindings; Variables: Variables }>
...
collectionRoutes.post('/', zValidator('json', createCollectionSchema), async (c) => {
  ...
  `,
    ...
    .bind(collectionId, tenantId, body.name, body.slug, body.description || '')
    .run()
