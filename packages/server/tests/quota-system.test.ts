...
describe('Quota Presets', () => {
  describe('QUOTA_PRESETS', () => {
    ...
    test('plans should scale appropriately', () => {
      expect(QUOTA_PRESETS.pro.max_requests_per_minute).toBe(
        QUOTA_PRESETS.free.max_requests_per_minute * 10,
      )
      expect(QUOTA_PRESETS.enterprise.max_requests_per_minute).toBe(
        QUOTA_PRESETS.pro.max_requests_per_minute * 10,
      )
    })
  })
