...
import { generateTestJWT, createMockTenant, MockD1Database, MockD1Statement } from './test-utils';
  ...
  async run() {
    ...
    if (query.includes('insert into tenants')) {
      ...
      const quotas = {
        ...
        max_requests_per_minute: newTenant.plan === 'free' ? 60 : newTenant.plan === 'pro' ? 600 : 6000,
        max_requests_per_day: newTenant.plan === 'free' ? 1000 : newTenant.plan === 'pro' ? 10000 : 100000,
        max_storage_bytes: newTenant.plan === 'free' ? 1073741824 : newTenant.plan === 'pro' ? 10737418240 : 107374182400,
